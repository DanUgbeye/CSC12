...
<div class="max-h-screen relative overflow-y-auto col-start-2 col-span-1 p-[20px]">
  ...
  <?php if (count($data) > 0) {
    echo ("
    <form method='POST' action='./edit.php' onsubmit='e.preventDefault();'>
    ...
    if ($editing_state) {
      echo (" <!-- SAVE BUTTON -->
      <button class='text-white py-3 px-4 rounded-md flex mt-[30px] ml-[20px] cursor-pointer bg-[#1db336] hover:bg-[#038013]' name='edit'>
      ...
      <button class='text-white py-3 px-4 rounded-md flex mt-[30px] ml-[20px] cursor-pointer bg-[#2F80ED] hover:bg-[#033e8b]' name='save'>
        <svg width='24' height='25' viewBox='0 0 24 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
 ...
 <!-- DELETE STUDENT BUTTON -->
      <button class='text-white py-3 px-4 bg-[#fc4747] rounded-md flex mt-[30px] ml-[20px] cursor-pointer hover:bg-[#d42020]' name='delete'>
